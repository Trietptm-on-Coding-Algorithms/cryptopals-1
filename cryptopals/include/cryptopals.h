...
#define SET_1_CHALLENGE_4_INPUT_1 "resources/4.txt"
...
#define SET_1_CHALLENGE_6_INPUT_1 "resources/6.txt"
#define SET_1_CHALLENGE_6_EXPECTED_OUTPUT "UNKNOWN: Yet to be solved."
